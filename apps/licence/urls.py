...
router.register(
    r"license-category-type",
    LicenseCategoryTypesViewset,
    basename="license-category-type",
)
router.register(
    r"license-category", LicenseCategoryViewset, basename="license-category"
)
router.register(r"license", LicenseViewset, basename="license")
router.register(
    r"license-checkout", LicenseCheckoutViewset, basename="license-checkout"
)
